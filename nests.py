...
nesting_mons = requests.get("https://raw.githubusercontent.com/ccev/pogoinfo/info/nests.json").json()
nest_mons = [str(m) for m in nesting_mons if m not in event_mons]
